...
import DropDownActions from "../utils/dropdonAction"
...
export default class UIActions {
  ...
  public async goto(URL: string, description: string) {
    ...
    await this.page.goto(URL, {timeout: 10000, waitUntil: "load"});
  }
  ...
  public async goBack(description: string) {
    ...
    await this.page.goBack({ timeout: 10000, waitUntil: "load" });
  }
  ...
  public async goForward(description: string) {
    ...
    await this.page.goForward({ timeout: 10000, waitUntil: "load" });
  }
  ...
  public async pauseInSecs(sec: number) {
    ...
    return new Promise((resolve) => setTimeout(resolve, sec * 10000));
  }
}
